...
heroBadges:
  - src: https://img.shields.io/github/v/release/mpesic84/winutil-app?color=%230567ff&label=Latest%20Release&style=for-the-badge
    alt: Latest release
    href: https://github.com/mpesic84/winutil-app/releases/latest
  - src: https://img.shields.io/github/downloads/mpesic84/winutil-app/winutil.ps1?label=Total%20Downloads&style=for-the-badge
    alt: Total downloads
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/mpesic84/winutil-app
      icon: external
      variant: secondary
head:
  - tag: meta
    ...
    content: |
      {
        ...
        "name": "WinUtil",
        "description": "Misa Pesic's Windows Utility — install apps, apply tweaks, run fixes, and manage Windows from one place. Fork of ChrisTitusTech/winutil.",
        "url": "https://mpesic84.github.io/winutil-app/",
        "downloadUrl": "https://github.com/mpesic84/winutil-app",
	...
	<div class="wu-section-inner">
		...
		<div class="wu-timeline">
			...
			<div class="wu-timeline-step">
				...
				<Code code={'irm "https://github.com/mpesic84/winutil-app/releases/latest/download/winutil.ps1" | iex'} lang="powershell" />
			</div>
			<div class="wu-timeline-step">
...
<section class="wu-section">
	<div class="wu-section-inner wu-text-narrow wu-cta">
		...
		<div class="wu-btn-row">
			...
			<a class="wu-btn wu-btn-secondary" href="https://github.com/mpesic84/winutil-app">
				<Icon name="github" />
				{' View on GitHub'}
			</a>
		</div>
