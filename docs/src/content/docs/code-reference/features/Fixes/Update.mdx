...
:::note
This page is generated from [`functions/public/Invoke-WPFFixesUpdate.ps1`](https://github.com/mpesic84/winutil-app/blob/main/functions/public/Invoke-WPFFixesUpdate.ps1). Do not edit this page directly.
:::
