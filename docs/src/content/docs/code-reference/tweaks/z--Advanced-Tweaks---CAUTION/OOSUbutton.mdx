...
:::note
This page is generated from [`functions/public/Invoke-WPFOOSU.ps1`](https://github.com/mpesic84/winutil-app/blob/main/functions/public/Invoke-WPFOOSU.ps1). Do not edit this page directly.
:::
