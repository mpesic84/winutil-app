...
4. Users download via `irm github.com/mpesic84/winutil-app/releases/latest/download/winutil.ps1`
...
- **GitHub Repository**: [mpesic84/winutil-app](https://github.com/mpesic84/winutil-app)
...
**Maintainers**: Misa Pesic and contributors (fork of [ChrisTitusTech/winutil](https://github.com/ChrisTitusTech/winutil))
