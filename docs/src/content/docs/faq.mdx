...
- Run only from the [official source](https://github.com/mpesic84/winutil-app/)
...
2. Run: `irm "https://github.com/mpesic84/winutil-app/releases/latest/download/winutil.ps1" | iex`
...
- **[GitHub Issues](https://github.com/mpesic84/winutil-app/issues)** — Report bugs
